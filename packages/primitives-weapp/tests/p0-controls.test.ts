...
describe('primitives-weapp p0 controls', () => {
  it('composes checkbox root and indicator with platform tags', async () => {
    const wrapper = mount(CheckboxRoot, {
      props: { as: 'button', defaultChecked: false },
      slots: {
        default: () => h(CheckboxIndicator, { as: 'text' }, { default: () => 'check' })
      }
    })
  ...
  it('does not toggle checkbox when disabled on a non-button element or when default is prevented', async () => {
    ...
    const disabled = mount(CheckboxRoot, {
      ...
      props: { as: 'view', defaultChecked: false, disabled: true }
    })
  ...
  it('composes radio group, item, and indicator with platform tags', async () => {
    ...
    const wrapper = mount(RadioGroup, {
      ...
      slots: {
        default: () => [
          h(RadioItem, { as: 'button', value: 'h5' }, { default: () => h(RadioIndicator, { as: 'text' }, { default: () => 'dot' }) }),
          h(RadioItem, { as: 'button', value: 'weapp' }, { default: () => 'Weapp' })
        ]
      }
    })
  ...
  it('keeps radio controlled when value is explicitly undefined', async () => {
    ...
    const wrapper = mount(RadioGroup, {
      ...
      slots: {
        default: () => h(RadioItem, { as: 'button', value: 'h5' }, { default: () => 'H5' })
      }
    })
  ...
  it('does not select radio when disabled on a non-button element or when default is prevented', async () => {
    ...
    const disabled = mount(RadioGroup, {
      ...
      slots: {
        default: () =>
          h(RadioItem, { as: 'view', disabled: true, value: 'h5', onClick: disabledClick }, { default: () => 'H5' })
      }
    })
    ...
    const prevented = mount(RadioGroup, {
      ...
      slots: {
        default: () =>
          h(
            RadioItem,
            { as: 'button', value: 'h5', onClick: (event: MouseEvent) => event.preventDefault() },
            { default: () => 'H5' }
          )
      }
    })
  ...
  it('keeps radio indicator in sync when item value changes', async () => {
    const Harness = defineComponent({
      ...
      setup(props) {
        return () =>
          h(RadioGroup, { as: 'view', value: 'weapp' }, {
            default: () =>
              h(RadioItem, { as: 'button', value: props.itemValue }, {
                default: () => h(RadioIndicator, { as: 'text' }, { default: () => 'dot' })
              })
          })
      }
    })
  ...
  it('composes switch root and thumb with platform tags', async () => {
    const wrapper = mount(SwitchRoot, {
      props: { as: 'button', defaultChecked: false },
      slots: {
        default: () => h(SwitchThumb, { as: 'view' }, { default: () => 'thumb' })
      }
    })
  ...
  it('does not toggle switch when loading on a non-button element or when default is prevented', async () => {
    ...
    const loading = mount(SwitchRoot, {
      ...
      props: { as: 'view', defaultChecked: false, loading: true }
    })
  ...
  it('composes tabs root, list, trigger, and content with platform tags', async () => {
    const Harness = defineComponent({
      setup() {
        return () =>
          h(TabsRoot, { as: 'view', defaultValue: 'docs' }, {
            default: () => [
              h(TabsList, { as: 'view' }, {
                default: () => [
                  h(TabsTrigger, { as: 'button', value: 'docs' }, { default: () => 'Docs' }),
                  h(TabsTrigger, { as: 'button', value: 'api' }, { default: () => 'API' })
                ]
              }),
              h(TabsContent, { as: 'view', value: 'docs' }, { default: () => 'Docs panel' }),
              h(TabsContent, { as: 'view', value: 'api' }, { default: () => 'API panel' })
            ]
          })
      }
    })
    ...
    const DisabledHarness = defineComponent({
      setup() {
        return () =>
          h(TabsRoot, { as: 'view', defaultValue: 'docs' }, {
            default: () =>
              h(TabsTrigger, { as: 'view', disabled: true, value: 'api', onClick: disabledClick }, {
                default: () => 'API'
              })
          })
      }
        ...
        return () =>
          h(TabsRoot, { as: 'view', defaultValue: 'docs' }, {
            default: () =>
              h(
                TabsTrigger,
                { as: 'button', value: 'api', onClick: (event: MouseEvent) => event.preventDefault() },
                { default: () => 'API' }
              )
          })
      }
