...
function MapField(name, id, keyType, type, options, comment) {
  ...
  /* istanbul ignore if */
  if (!util.isString(keyType)) { throw new TypeError('keyType must be a string') }
...
MapField.prototype.resolve = function resolve() {
  ...
  if (types.mapKey[this.keyType] === undefined) { throw new Error(`invalid key type: ${this.keyType}`) }
