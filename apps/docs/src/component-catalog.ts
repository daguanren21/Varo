...
export const componentCatalog: readonly ComponentCatalogGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'date-field', name: 'DateField', label: { zh: '日期字段', en: 'Date Field' }, targets: dualTarget },
      ...
      { id: 'picker', name: 'Picker', label: { zh: '选择器', en: 'Picker' }, targets: dualTarget },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'list', name: 'List', label: { zh: '列表加载', en: 'List Loading' }, targets: dualTarget },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'watermark', name: 'Watermark', label: { zh: '水印', en: 'Watermark' }, targets: dualTarget },
      { id: 'popup', name: 'Popup', label: { zh: '弹出层', en: 'Popup' }, targets: dualTarget },
      { id: 'pull-refresh', name: 'PullRefresh', label: { zh: '下拉刷新', en: 'Pull Refresh' }, targets: dualTarget },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'signature', name: 'Signature', label: { zh: '签名', en: 'Signature' }, targets: dualTarget },
