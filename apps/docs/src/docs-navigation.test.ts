...
describe('docs navigation', () => {
  ...
  it('keeps the shadcn guide focused on installation and usage', () => {
    const config = readFileSync(configPath, 'utf8')
    ...
    expect(shadcnZh).toContain('pnpm dlx @varo-ui/cli add --target h5 button form toast')
    expect(shadcnZh).toContain('pnpm dlx @varo-ui/cli add --target weapp-vite button form toast')
    expect(shadcnZh).toContain('pnpm dlx @varo-ui/cli add --target weapp-vite --force button')
    expect(shadcnZh).toContain('pnpm dlx @varo-ui/cli add --target weapp-vite components/agent-ui')
    expect(shadcnZh).toContain('import { shallowRef } from \'vue\'')
    expect(shadcnZh).toContain('import { shallowRef } from \'wevu\'')
    expect(shadcnZh).toContain('import { VButton } from \'@/components/ui/button\'')
    ...
    expect(shadcnEn).toContain('pnpm dlx @varo-ui/cli add --target h5 button form toast')
    expect(shadcnEn).toContain('pnpm dlx @varo-ui/cli add --target weapp-vite button form toast')
    expect(shadcnEn).toContain('pnpm dlx @varo-ui/cli add --target weapp-vite --force button')
    expect(shadcnEn).toContain('pnpm dlx @varo-ui/cli add --target weapp-vite components/agent-ui')
    expect(shadcnEn).toContain('import { shallowRef } from \'vue\'')
    expect(shadcnEn).toContain('import { shallowRef } from \'wevu\'')
    expect(shadcnEn).toContain('import { VButton } from \'@/components/ui/button\'')
