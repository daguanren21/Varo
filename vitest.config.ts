...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@varo/weapp-web': resolve(import.meta.dirname, 'packages/weapp-web/src/index.ts'),
      '@varo/weapp-web/plugin': resolve(import.meta.dirname, 'packages/weapp-web/src/plugin/index.ts'),
      '@varo/weapp-web/runtime': resolve(import.meta.dirname, 'packages/weapp-web/src/runtime/index.ts'),
